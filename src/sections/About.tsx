...
const About = () => {
  return (
    <div className="px-4 md:px-12 xl:px-64 pt-12" >
      <WaterDropGrid />
      <TitleWithLine title="About" />
      <div className="md:flex w-full text-sm md:text-base md:gap-2 space-y-4 md:space-y-0">
        <div className="text-white md:w-2/3 text-justify md:leading-relaxed">
          <span className="bg-indigo-500 text-white py-2 px-3 rounded font-bold mr-1 float-left text-2xl">
            H
          </span>
          ey! I'm <span className="text-lg font-bold text-indigo-500">Pyae Sone Htun</span>, if you haven't already gathered that by now. I'm a
        ...
        <div className="md:px-4">
          <div className="text-white pb-3 text-lg font-bold">Use At Work</div>
          ...
          <div className="text-white py-3 text-lg font-bold">Use For Fun</div>
